...
//		System.out.println(my.hdl.HDL.enCode("eddeddedde", "bbbbbb"));
		for (int i = 0; i < 154; i++){
			System.out.print(HDL.hdlAlphabet[i].getOrigin() + " ");
		System.out.println(my.hdl.HDL.deCode("103070078081077070055142129070064071053055053053", "EГ6РЕ%@" /*+ HDL.hdlAlphabet[i].getOrigin()*/));
		}
...
//		System.out.println(encryption.OurCode.encode("Рома, какой счет? :)", "яяяяяя"));
//		System.out.println(HDL.encodeReverse("Рома, какой счет? :)", "яяяяяя"));
